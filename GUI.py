...
class Calculator(QWidget):
    ...
    def initUI(self):
        ...
        self.multi_button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.div_button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.equal_button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.one.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.two.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.three.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.four.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.five.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.six.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.seven.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.eight.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.nine.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.zero.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.clear.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
        self.sub_button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def on_click(self, pressed):
        if pressed == "C":
            ...
            self.numbers.setText(f"{self.numbers.text()}{pressed:}") 
